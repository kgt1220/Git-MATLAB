function DRER_chua_recon_scaled10(r,N)
InitLen = 1000;
TrainLen = 4000;
TestLen = 1000; 
K_start = 0; K_step = 0.1; K_final = 5;
push = 0;
load('./Data/chua_scaled.mat')
Y_recon  = scaled_y;  Z_recon  = scaled_z;
...
for K = K_start:K_step:K_final
  %  tic
    ...
    load(['./Reservoirs/Lin1-1.3/Chua/scaled10/N' num2str(N) '/r' num2str(r) 'K' num2str(K) 'limit7000.mat']);
...
save(['./Errors/Lin1-1.3/Chua/scaled10_train' num2str(TrainLen) ',r' num2str(r) 'N' num2str(N) 'K' num2str(K) '.mat'],'K','N','Train_mse','Test_mse','InitLen','TrainLen','TestLen','data','Yt','w')
end