function second_reservoir_chua_scaled10(r,N)
mkdir (['./Reservoirs/Lin1-1.3/Chua/scaled10/N' num2str(N) ''])

load(['./order_sequence_diverse_Nodes/r' num2str(r) 'order_sequence_Node' num2str(N) '_lin113.mat'])
load('./Data/chua_scaled.mat'); data = scaled_x; data = 10*(data/max(abs(data)));
...
K_step = -K_step_minus; K_final = 5;
    ...
    for K = K_start:K_step:K_final
        ...
        save(['./Reservoirs/Lin1-1.3/Chua/scaled10/N' num2str(N) '/r' num2str(r) 'K' num2str(K) 'limit' num2str(limit) '.mat'])
        fprintf('r = %d, ep = %d \n', r, K)
        toc
    end
