function documents = novelsDocuments7()
...
txt = extractFileText("Harry Potter and the Deathly Hallows.txt");
...
novels = replace(novels,"EPILOGUE","");
novels = replace(novels,"E P I L O G U E","");
